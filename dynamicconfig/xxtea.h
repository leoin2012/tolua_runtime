 ...
 * @len:     Length of the data to be encrypted
 * @key:     Symmetric key
 * @out_len: Length of the Symmetric key
 * Returns:  Encrypted data or %NULL on failure
 *
 * Caller is responsible for freeing the returned buffer.
 */
char * xor_encrypt(const char * data, size_t len, const char * key, size_t key_len);
 ...
 * Caller is responsible for freeing the returned buffer.
 */
char * xor_decrypt(const char * data, size_t len, const char * key, size_t key_len);
